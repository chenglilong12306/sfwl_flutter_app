...
class TslTransportTaskInfo {
  ...
  TslTransportTaskInfo(this.load_id, this.load_addtime, this.load_comid,
      this.load_subid, this.load_sn, this.load_Dirs, this.load_carNumber,
      this.load_carNumber_cx, this.load_fengqian, this.sload_trailerNumber,
      this.load_state, this.load_sendTime, this.load_other, this.load_isHaving,
      this.load_beginCityName, this.load_endCityName, this.load_tracid, this.load_tracTnumber,
      this.load_tracType, this.load_tracState, this.load_tracSource, this.load_trdState);
  ...
  factory TslTransportTaskInfo.fromJson(Map<String, dynamic> jsonStr) {
    return TslTransportTaskInfo(jsonStr['load_id']
        ...
        , jsonStr['sload_trailerNumber'] != null ? jsonStr['sload_trailerNumber'] : ""
        , jsonStr['load_state']
        , jsonStr['load_sendTime']
        , jsonStr['load_other'] != null ? jsonStr['load_other'] : ""
        , jsonStr['load_isHaving']
        , jsonStr['load_beginCityName']
        , jsonStr['load_endCityName']
        , jsonStr['load_tracid']
        , jsonStr['load_tracTnumber']
        , jsonStr['load_tracType']
        , jsonStr['load_tracState']
